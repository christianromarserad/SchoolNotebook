// This component is used to display the menu item that has an options to delete and edit a reminder note
...
class ReminderNoteItemMenu extends Component {
    render() {
        return (
...
export default (ReminderNoteItemMenu);